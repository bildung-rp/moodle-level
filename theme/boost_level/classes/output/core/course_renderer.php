...
namespace theme_boost_level\output\core;
   ...
   /**
    ...
    public function course_modchooser($modules, $course) {
        ...
        $modchooser = new \core_course\output\modchooser($course, $modules);
         // +++ SYNERGY LEARNING: add information to instructions.
        if (file_exists($CFG->dirroot . '/local/authoringcapability/classes/local/corechanges.php')) {
            $infotext = \local_authoringcapability\local\corechanges::render_modchooser_informationtext();
            $infotext = format_text($infotext, FORMAT_HTML);
            $modchooser->set_instructions($infotext);
        }
        // +++ SYNERGY LEARNING: add information to instructions.
