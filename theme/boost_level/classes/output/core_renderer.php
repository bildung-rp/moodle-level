...
namespace theme_boost_level\output;
...
class core_renderer extends \core_renderer {
    ...
    public function full_header() {
        ...
        return $this->render_from_template('theme_boost_level/header', $header);
    }
     ...
     *
     * Is only uses to execute code before outputting header.
     *
     * @return string
     */
